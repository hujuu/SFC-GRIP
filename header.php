            ...
            <div id="header_social_cont">
            	...
            	<div id="header_social">
                    ...
                    <div class="header_rss">
                    	<p><a href="<?php bloginfo('rss2_url'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/twitter.png" width="35" height="35" border="0" alt="Rss" /></a></p>
                        <p><a href="<?php bloginfo('rss2_url'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/facebook.png" width="35" height="35" border="0" alt="Rss" /></a></p>
                        <p><a href="<?php bloginfo('rss2_url'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/google.png" width="35" height="35" border="0" alt="Rss" /></a></p>
                    </div>
                    <!--
